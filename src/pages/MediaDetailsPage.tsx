...
const schemaData = {
  ...
  "url": `https://moviego.st${location.pathname}`,
  ...
  return (
	...
	<Helmet>
        <link rel="canonical" href={`https://moviego.st${location.pathname}`} />
        ...
        <meta property="og:url" content={`https://moviego.st${location.pathname}`} />
